 ...
 */
public class StackLL<T extends Comparable<T>> implements IStack<T>, Comparable<StackLL<T>>
{
	private Node m_head;
	private int m_count;
	...
	@Override
	public int compareTo(StackLL<T> otherDude) 
	{
		return top().compareTo(otherDude.top());
	}
